            ...
            <div className="input-suggest-wrapper  flex items-center">
              <div className="chatSuggQuestWrapper  w-3/12  flex justify-center items-center">
                ...
                >
                  ...
                  <option className="dropdownColor"  value=" Ask a question question about  Family Law">
                    Family Law
                  </option>
                  <option className="dropdownColor" value=" Ask a question question about   Business Law">
                    Business Law
                  </option>
                  <option className="dropdownColor" value=" Ask a question question about Criminal Law">
                    Criminal Law
                  </option>
                  <option className="dropdownColor" value="  Ask a question question about Civil Law">
                    Civil Law
                  </option>
                </select>
              </div>
